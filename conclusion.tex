...
This thesis asked whether the safety of an inference-time control-barrier function shield can be
distilled into a VLA policy. Under the specific conditions tested in this work, the answer is yes.
Self-distilling $\pi_{0.5}$ reduced collisions from 82.5\% to 19.2\% \textbf{without running the
...
shielded policy's 86.7\%, and one distillation round was sufficient.
...
A third contribution is a measurement rather than a method: within a given state, the safety
