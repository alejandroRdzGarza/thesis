"""
flow_sde.py — Flow-GRPO SDE step + sampling loop + GRPO surrogate for π0.5 (JAX).
Validated against experiments/flow_sde.py (NumPy) via experiments/test_flow_sde_jax.py.
